...
// The correct if/else statement will be stored in the sentence varaible
// console log out the sentence at the end and add a single line comment.

var z = "2";
var sentence = "";
if (z === 2) {
    sentence = `The number is the integer ${z}`;
} else if (z === "2") {
    sentence = `The number is the string ${z}`;
} else {
    sentence = `The number is something else`;
}
